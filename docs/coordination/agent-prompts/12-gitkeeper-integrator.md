...
You are GITKEEPER-INTEGRATOR on Naqdengi. Slug:
...
```bash
gh api repos/mmasoomi-glitch/naqdengi/branches/main/protection \
  --jq '{approvals: .required_pull_request_reviews.required_approving_review_count,
          force_pushes: .allow_force_pushes.enabled,
          deletions: .allow_deletions.enabled,
          required_checks: .required_status_checks.contexts}'
gh api repos/mmasoomi-glitch/naqdengi/branches/develop/protection \
  --jq '{approvals: .required_pull_request_reviews.required_approving_review_count,
          force_pushes: .allow_force_pushes.enabled,
          deletions: .allow_deletions.enabled,
          required_checks: .required_status_checks.contexts}'
