...
11
$ gh api repos/mmasoomi-glitch/naqdengi --jq .default_branch
main
```
...
```text
$ npx prisma migrate diff --from-migrations prisma/migrations     --to-schema-datamodel prisma/schema.prisma     --shadow-database-url .../naqdengi_shadow_probe --exit-code
